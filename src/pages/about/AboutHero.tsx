          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400">
                We're a team of passionate digital creators, strategists, and technologists dedicated to transforming businesses through innovative digital solutions. With a proven track record of success across multiple industries, we bring expertise and creativity to every project.
              </p>
              <Link
                to="/quote"
