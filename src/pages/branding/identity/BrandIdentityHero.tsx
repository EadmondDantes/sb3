          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400">
                Create a powerful and cohesive brand identity that resonates with your audience and sets you apart from competitors. Our comprehensive brand identity services help you build a strong, memorable brand presence.
              </p>
              <Link
                to="/quote"
