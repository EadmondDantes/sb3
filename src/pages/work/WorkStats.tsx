...
import { FaShoppingCart, FaUsers, FaGlobe, FaStar } from 'react-icons/fa';
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm p-8 rounded-xl border border-gray-800 text-center">
                ...
                <div className="text-3xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">
                  {stat.value}
                </div>
